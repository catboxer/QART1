    ...
    <div className="App" style={{ textAlign: 'left' }}>
      ...
      <div style={{ marginTop: '1rem' }}>
        <label style={{ display: 'block', fontSize: 14, marginBottom: 4 }}>
          ...
          <span style={{ color: '#374151', fontWeight: 400 }}> — needed to link your sessions across devices. Please use the same email every time you participate. Your email is stored separately from your session results and questionnaire responses, and is never combined with them in a single record.</span>
        </label>
        <input
          type="email"
          value={emailValue}
