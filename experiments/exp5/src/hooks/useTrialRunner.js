  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Randomize target for the next set of blocks — unless the target
        // is fixed for the whole session (C.TARGET_ASSIGNMENT === 'per_session')
        if (C.TARGET_ASSIGNMENT !== 'per_session') {
