...
function UnifiedTemporalControlAnalysis({ sessions }) {
  const temporalMetrics = useMemo(() => {
    // Block-to-block analysis for individual blocks (576 subject + 576 demon trials = 1153 bits fetched per block)
    ...
    <div>
      ...
      {controlMetrics.trialLevelValidation && controlMetrics.trialLevelValidation.available && (
        <div style={{ marginTop: 32, padding: 20, border: '2px solid #0369a1', borderRadius: 8, background: '#eff6ff' }}>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ marginTop: 16 }}>
                ...
                <div style={{ fontSize: 10, color: '#6b7280', marginTop: 8, fontStyle: 'italic' }}>
                  Subject-Demon tests validate independence between the randomly split halves (576 subject + 576 demon). Audit tests validate independence of baseline QRNG fetches (1000 bits every 5 blocks, split in half for testing).
                </div>
              </div>
            </div>
          )}
          ...
          <div style={{ fontSize: 11, color: '#6b7280', fontStyle: 'italic' }}>
            Trial-level validation uses raw quantum trial data. Each block fetches 1153 bits (1 assignment + 576 subject + 576 demon) and randomly assigns first/second half to subject/demon.
