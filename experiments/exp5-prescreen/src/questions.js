export const preQuestions = [
  ...
  {
    id: 'psiConfidence',
    question: 'Do you have a psychic ability that you can actively use?',
    type: 'radio',
    options: [
      { label: 'Yes, I have an ability I can actively use', value: 'yes_active' },
      { label: 'Yes, but it\'s inconsistent or unreliable', value: 'yes_inconsistent' },
      { label: 'I\'ve had experiences but wouldn\'t call it a skill', value: 'experiences_only' },
      { label: 'No', value: 'no' },
    ],
  },
];
