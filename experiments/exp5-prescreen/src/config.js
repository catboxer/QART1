...
config.experiments = {
  pk: {
    ...
    BLOCKS_TOTAL: 40,             // 40 blocks of focus → fetch → results
    TRIALS_PER_BLOCK: 576,        // 576 trials per block (instant processing)
    BITS_PER_BLOCK: 1153,         // 1153 bits: 1 for assignment + 1152 for trials (576 subject, 576 PCS)
    ...
    // Finite-sample null distribution for single-scale R/S Hurst on 576 random bits
    // Derived from 10,000 simulations using identical hurstApprox formula
    NULL_HURST_MEAN: 0.52729,
    NULL_HURST_SD:   0.03500,
    NULL_HURST_P10:  0.48230,
    NULL_HURST_P25:  0.50301,
    NULL_HURST_P50:  0.52737,
    NULL_HURST_P75:  0.55120,
    NULL_HURST_P90:  0.57247,
    NULL_HURST_P95:  0.58601,
