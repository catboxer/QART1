...
config.experiments = {
  pk: {
    ...
    AI_MODE_SESSIONS: 7, // Set this in ai-config.js as it reads it from there. Number of AI agent sessions to run (access via #ai URL /exp4#ai) - run sh experiments/exp4/run-ai.sh first
  },
};
