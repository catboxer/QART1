...
config.experiments = {
  pk: {
    ...
    AUTO_MODE_SESSIONS: 1, // Number of automated baseline sessions to run (access via #auto URL /exp3#auto)
    AUTO_MODE_REST_MS: 1000, // 1 second auto-continue delay between blocks in auto-mode
    AI_MODE_SESSIONS: 7, // Set this in ai-config.js as it reads it from there. Number of AI agent sessions to run (access via #ai URL /exp3#ai) - run sh experiments/exp3/run-ai.sh first
  },
};
